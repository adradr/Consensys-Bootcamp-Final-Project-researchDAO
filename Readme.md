...
Internal membership application and share minting can happen with super majority. It means in terms of researchDAO that 3/5 or 60% is required to pass voting.
